...
*/
	...
	require_once "VacantControllerClass.php";
	...
	if ( isset($_REQUEST['controllerType']) )
    {
		...
		switch ( $action )
		{
			...
			case 1:
				...
				break;
			case 2:
				$vacantController = new VacantControllerClass( $_REQUEST['action'], $_REQUEST['jsonData'] );
				$outPutData = $vacantController->doAction();
				break;
			case 3:
